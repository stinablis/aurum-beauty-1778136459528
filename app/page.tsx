...
const basePath = '/aurum-beauty-1778136459528';
...
export default function Home() {
  ...
  const submit = (e: any) => {
    ...
    window.open(`https://wa.me/60112233445?text=${msg}`, '_blank');
  };
  ...
  const products = [{ n: 'Hair Styling', d: 'Cut, colour, and treatment by senior stylists', i: 'https://images.pexels.com/photos/19482851/pexels-photo-19482851.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'Facial', d: 'Deep cleanse and brightening treatment', i: 'https://images.pexels.com/photos/19242408/pexels-photo-19242408.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'Nail Art', d: 'Gel, acrylic, and premium nail designs', i: 'https://images.pexels.com/photos/4965824/pexels-photo-4965824.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'Lash & Brow', d: 'Extensions, lifts, and tinting', i: 'https://images.pexels.com/photos/7446922/pexels-photo-7446922.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Bridal Package', d: 'Full glam for your special day', i: 'https://images.pexels.com/photos/26181073/pexels-photo-26181073.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body selection:bg-accent/30 selection:text-primary">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl shadow-sm">
        <div className="flex justify-between items-center w-full px-8 py-4 max-w-7xl mx-auto">
          <div className="flex items-center gap-3">
            <span className="text-2xl font-black tracking-tighter text-primary font-headline">Aurum Beauty</span>
          </div>
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://images.pexels.com/photos/7195799/pexels-photo-7195799.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="Hero" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 w-full">
          <div className="max-w-3xl">
            ...
            <h1 className="font-headline text-5xl md:text-7xl font-extrabold text-white leading-[1.1] mb-8 tracking-tighter">
              Where beauty meets <span className="text-accent">luxury..</span>
            </h1>
            <p className="text-white/80 text-lg md:text-xl max-w-xl mb-10 leading-relaxed font-light">
              Aurum Beauty delivers visionary solutions through sustainable design and uncompromising excellence.
            </p>
            <a
              href={`https://wa.me/60112233445`}
              target="_blank"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At Aurum Beauty, we are dedicated to providing exceptional beauty services that exceed our clients\' expectations. With a team of highly skilled and experienced professionals, we strive to create a welcoming and luxurious atmosphere where individuals can indulge in a range of treatments. From hair styling to nail art, our goal is to help each client unlock their unique beauty and confidence.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">Our vision is to become the premier destination for beauty and luxury services, renowned for excellence, innovation, and unparalleled client experiences.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">Our mission is to empower individuals to feel confident and beautiful by delivering personalized, high-quality beauty services with elegance, refinement, and exceptional customer care.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Elegance</h4>
                  <p className="text-sm text-on-surface-variant">Every service delivered with grace and refinement.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Confidence</h4>
                  <p className="text-sm text-on-surface-variant">You leave looking and feeling your best.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://images.pexels.com/photos/21044856/pexels-photo-21044856.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 1" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.pexels.com/photos/8834017/pexels-photo-8834017.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.pexels.com/photos/4974567/pexels-photo-4974567.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-12">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">book@aurumbeauty.com</p>
                  </div>
                </div>
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">60112233445</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-primary w-full py-12 px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-center text-center md:text-left">
          <div>
            <div className="text-xl font-bold text-white mb-4">Aurum Beauty</div>
            <p className="text-white/60 text-sm leading-relaxed">Where beauty meets luxury.</p>
          </div>
          <div className="flex justify-center md:justify-center gap-6">
            
            
            <a href={`https://wa.me/60112233445`} target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors text-sm">WhatsApp</a>
          </div>
          <div className="md:text-right">
            <p className="text-white/60 text-sm leading-relaxed">
              © {new Date().getFullYear()} Aurum Beauty. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
